...
exports._transformNode = function (node) {
  ...
  if (node.type === 'VariableDeclaration') {
    ...
    if (varDeclaration.endToken.value === ';') {
      ...
      // If there was indentation, unindent the remaining content
      if (varIndentationToken) {
        // For each of the declarations, perform unindentation
        ...
        declarations.forEach(function unindentDeclarationContent (declaration, indentation) {
