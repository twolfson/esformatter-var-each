...
exports.transform = function (ast) {
  ...
  if (node.type === 'VariableDeclaration') {
    ...
    if (varDeclaration.endToken.value === ';') {
      ...
      declarations.forEach(function indentDeclaration (declaration) {
        // Add willy nilly indentation
        var oldStartToken = declaration.startToken;
        declaration.startToken = {
          // TODO: This probably covers too many cases
          type: 'LineBreak',
          value: '\n',
          prev: oldStartToken.prev,
          next: oldStartToken
        };
        if (declaration.startToken.prev) {
          declaration.startToken.prev.next = declaration.startToken;
        ...
        console.log(declaration.startToken.type, JSON.stringify(declaration.startToken.value));
        console.log(declaration.startToken.next.type, JSON.stringify(declaration.startToken.next.value));
        console.log(declaration.startToken.next.next.type, JSON.stringify(declaration.startToken.next.next.value));
        console.log(declaration.startToken.next.next.next.type, JSON.stringify(declaration.startToken.next.next.next.value));
        console.log(declaration.startToken.next.next.next.next.type, JSON.stringify(declaration.startToken.next.next.next.next.value));
        console.log(declaration.startToken.next.next.next.next.next.type, JSON.stringify(declaration.startToken.next.next.next.next.next.value));
      });
    }
