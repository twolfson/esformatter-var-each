  ...
  if (node.type === 'VariableDeclaration') {
    ...
    if (varDeclaration.endToken.value === ';') {
      ...
      declarations.forEach(function indentDeclaration (declaration) {
        ...
        console.log(oldStartToken.type, JSON.stringify(oldStartToken.value));
        console.log(oldStartToken.next.type, JSON.stringify(oldStartToken.next.value));
        console.log(oldStartToken.next.next.type, JSON.stringify(oldStartToken.next.next.value));
        console.log(oldStartToken.next.next.next.type, JSON.stringify(oldStartToken.next.next.next.value));
        console.log(oldStartToken.next.next.next.next.type, JSON.stringify(oldStartToken.next.next.next.next.value));
      });
    }
